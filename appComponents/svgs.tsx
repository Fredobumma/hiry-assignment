...
export const ProfileSvg = () => (
	...
	>
		<path
			d="M10.5 4C10.5 5.38071 9.38069 6.5 7.99998 6.5C6.61926 6.5 5.49998 5.38071 5.49998 4C5.49998 2.61929 6.61926 1.5 7.99998 1.5C9.38069 1.5 10.5 2.61929 10.5 4Z"
			stroke="#7730F7"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
		/>
		<path
			d="M3.00073 13.4122C3.0476 10.6913 5.26789 8.5 7.99998 8.5C10.7321 8.5 12.9525 10.6914 12.9992 13.4124C11.4774 14.1107 9.78424 14.5 8.00019 14.5C6.21597 14.5 4.52271 14.1106 3.00073 13.4122Z"
			stroke="#7730F7"
			strokeWidth="1.5"
			strokeLinecap="round"
			strokeLinejoin="round"
...
export const DottedLineSvg = () => (
	<svg
		...
		xmlns="http://www.w3.org/2000/svg"
	>
		<path d="M1 0V36" stroke="#C1B1FE" strokeDasharray="4 4" />
	</svg>
);
...
export const ProfilePictureSvg = () => (
	<svg
		xmlns="http://www.w3.org/2000/svg"
		width="120"
		height="120"
		...
		fill="none"
	>
		<g clipPath="url(#clip0_3597_1142)">
			<path
				d="M135 130H-15C-15 102.386 22.3442 79.9998 60 79.9998C97.6558 79.9998 135 102.386 135 130Z"
				fill="#B7F22A"
			/>
			<path
				d="M60 69.9999C73.8071 69.9999 85 58.807 85 44.9999C85 31.1928 73.8071 19.9999 60 19.9999C46.1929 19.9999 35 31.1928 35 44.9999C35 58.807 46.1929 69.9999 60 69.9999Z"
				fill="#B7F22A"
			/>
		</g>
		<defs>
			<clipPath id="clip0_3597_1142">
				<path
